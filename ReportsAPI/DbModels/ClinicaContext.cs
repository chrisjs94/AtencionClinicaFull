...
namespace ReportsAPI.DbModels
{
    public partial class ClinicaContext : DbContext
    {
        ...
        public virtual DbSet<vwBillProductsServices> VwBillProductsServices { get; set; }
        ...
        public virtual DbSet<VwTestsResults> VwTestsResults { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=db_a73688_florsacuanjoche;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bill>(entity =>
            {
                ...
                entity.Property(e => e.IsCredit).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<vwBillProductsServices>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<VwTestsResults>(entity =>
            {
                entity.HasNoKey();
